    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="text-center">
          ...
          <p className="text-gray-700">A glorious Achievement</p>
        </div>
        <div className="text-center">
          <div className="flex items-center justify-center w-10 h-10 mx-auto mb-3 rounded-full bg-primary sm:w-12 sm:h-12">
            <svg
          ...
          <p className="text-gray-700">All Satisfied members</p>
        </div>
        <div className="text-center">
          <div className="flex items-center justify-center w-10 h-10 mx-auto mb-3 rounded-full bg-primary sm:w-12 sm:h-12">
            <svg
          ...
          <p className="text-gray-700">Never Old Fashioned</p>
        </div>
        <div className="text-center">
          <div className="flex items-center justify-center w-10 h-10 mx-auto mb-3 rounded-full bg-primary sm:w-12 sm:h-12">
            <svg
          ...
          <p className="text-gray-700">Successfull Growing Business</p>
        </div>
      </div>
    </div>
  );
